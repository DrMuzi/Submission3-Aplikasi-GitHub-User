package com.dimas.githubuserapp3.ui.follows
...
import com.dimas.githubuserapp3.adapter.UserFollowsAdapter
import com.dimas.githubuserapp3.databinding.FragmentFollowsBinding
...
class FollowsFragment : Fragment() {
    ...
    private fun showProgressBar(state: Boolean) {
        binding.animLoader.visibility = if (state) View.VISIBLE
        else View.GONE
    }
